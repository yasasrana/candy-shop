<template>
	<div>
		<img
			className="w-full absolute h-[600px] object-cover "
			alt="Candy"
					...
					<div class="p-5">
						...
						>
							...
							<button
								...
								class="inline-flex w-full items-center justify-center rounded-lg bg-primary hover:bg-secondary p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-1 disabled:bg-gray-400"
							>
								Continue
							</button>
